...
def merge(in_data, strVectorFile, seg_type, pix, xoff=None, yoff=None, xsize=None, ysize=None):
    ...
    while c < len(contours):
        ...
        if ioro == -1:
            ...
            oFeatureTriangle.SetField(1, map_dict.get(seg_type).get('ClsName'))
            oFeatureTriangle.SetField(2, map_dict.get(seg_type).get('LabelCode'))
            oFeatureTriangle.SetField(3, map_dict.get(seg_type).get('LabelName'))
